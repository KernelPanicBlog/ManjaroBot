...
def command_isos(m):
    ...
    gnome32 = types.InlineKeyboardButton('Gnome 32 Bits', url="https://downloads.sourceforge.net/manjarolinux/manjaro-gnome-17.0-stable-i686.iso")
    gnome64 = types.InlineKeyboardButton('Gnome 64 Bits', url="https://downloads.sourceforge.net/manjarolinux/manjaro-gnome-17.0-stable-x86_64.iso.torrent")
