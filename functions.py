...
def command_new_user(m):
    ...
    elif (m.new_chat_member.first_name != None and m.new_chat_member.last_name != None):
    ...
    elif (m.new_chat_member.username != None and m.new_chat_member.first_name != None):
    ...
    elif (m.new_chat_member.username != None and m.new_chat_member.last_name != None):
